...
<div class="max-w-sm rounded overflow-hidden shadow-lg mx-auto">
  ...
  <div class="px-6 py-4">
    ...
    <p class="text-gray-700 text-base">
      Lorem ipsum dolor sit amet, consectetur aje tje testesdestetdipisicing elit. Voluptkjhksdsdhkhjatibus quia, nulla! Maiores et perferendis eaque, exercitationem praesentium nihil.
    </p>
  </div>
  <div class="px-6 py-4">
...
<div class="max-w-sm rounded overflow-hidden shadow-lg mx-auto">
  ...
  <div class="px-6 py-4">
    <div class="font-bold text-xl mb-2">The Coldest Sunset</div>
    <p class="text-gray-700 text-base">
      Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus quia, nulla! Maiores et perferenddddis eaque, exercitationem praddesentium nihil.
    </p>
  </div>
  <div class="px-6 py-4">
    <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2">#photography</span>
