...
<div class="max-w-sm rounded overflow-hidden shadow-lg mx-auto">
  ...
  <div class="px-6 py-4">
    ...
    <p class="text-gray-700 text-base">
      Lorem ipsum dolor sit amet, consectetur aje tje testesdestetdipisicing elit. Voluptkjhkhkhjatibus quia, nulla! Maiores et perferendis eaque, exercitationem praesentium nihil.
    </p>
  </div>
  <div class="px-6 py-4">
